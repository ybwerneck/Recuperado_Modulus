...
:math:`ms`) generated from finite difference simulations, using `Devito <https://github.com/devitocodes/devito/tree/master/external/examples/seismic/tutorials>`_, as constraints for the temporal boundary conditions, and train
...
.. literalinclude:: /external/examples/seismic_wave/wave_2d.py
   :language: python
   :lines: 39-108
