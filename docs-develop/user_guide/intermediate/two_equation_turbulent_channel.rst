...
.. literalinclude:: /external/examples/turbulent_channel/2d_std_wf/u_tau_lookup.py
   :language: python
...
.. literalinclude:: /external/examples/turbulent_channel/2d_std_wf/custom_k_ep.py
   :language: python
...
.. literalinclude:: /external/examples/turbulent_channel/2d_std_wf/custom_aggregator.py
   :language: python

The custom aggregator is then called in the config files under the ``loss`` config group as shown here:

.. literalinclude:: /external/examples/turbulent_channel/2d_std_wf/conf_re590_k_ep/config.yaml
   :language: yaml
...
.. literalinclude:: /external/examples/turbulent_channel/2d_std_wf/re590_k_ep.py
   :language: python
...
.. literalinclude:: /external/examples/turbulent_channel/2d/re590_k_ep_LS.py
   :language: python
