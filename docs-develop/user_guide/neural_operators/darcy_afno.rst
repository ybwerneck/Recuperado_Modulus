...
.. literalinclude:: /external/examples/darcy/conf/config_AFNO.yaml
   :language: yaml
...
.. literalinclude:: /external/examples/darcy/darcy_AFNO.py
   :language: python
   :lines: 20-36
...
.. literalinclude:: /external/examples/darcy/conf/config_AFNO_MP.yaml
   :language: yaml
...
.. literalinclude:: /external/examples/darcy/darcy_AFNO_MP.py
   :language: python
   :lines: 20-21
