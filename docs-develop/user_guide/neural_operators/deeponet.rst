...
.. literalinclude:: /external/examples/anti_derivative/data_informed.py
   :language: python
   :lines: 1-15
...
.. literalinclude:: /external/examples/anti_derivative/conf/config.yaml
   :language: yaml
...
.. literalinclude:: /external/examples/anti_derivative/physics_informed.py
   :language: python
   :lines: 1-15
...
.. literalinclude:: /external/examples/darcy/darcy_DeepO.py
   :language: python
   :start-after: [datasets] 
   :end-before: [datasets]
...
.. literalinclude:: /external/examples/darcy/conf/config_DeepO.yaml
   :language: yaml
