...
def run(cfg: ModulusConfig) -> None:
    ...
    nodes = (
        ns.make_nodes(create_instances=2, freeze_terms={'continuity_0': [], 'momentum_x_0': [1, 2], 'momentum_y_0': [1, 2],
                                                        'continuity_1': [], 'momentum_x_1': [3, 4], 'momentum_y_1': [3, 4]})
    ...
    interior = PointwiseInteriorConstraint(
        nodes=nodes,
        geometry=geo,
        outvar={"continuity_0": 0, "momentum_x_0": 0, "momentum_y_0": 0,
                "continuity_1": 0, "momentum_x_1": 0, "momentum_y_1": 0,},
