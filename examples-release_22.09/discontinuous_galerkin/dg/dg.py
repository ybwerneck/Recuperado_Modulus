...
from modulus.utils.vpinn.test_functions import (
    RBF_Function,
    Test_Function,
    Legendre_test,
    Trig_test,
)
from modulus.utils.vpinn.integral import tensor_int, Quad_Rect, Quad_Collection
...
from modulus.dataset import DictVariationalDataset
