...
@modulus.main(config_path="conf_heat", config_name="config")
def run(cfg: ModulusConfig) -> None:
    ...
    openfoam_var = csv_to_dict(
        to_absolute_path("../openfoam/FPGA_re13239.6_tanh_OF_blockMesh_fullFake.csv"),
        mapping,
    )
    ...
    openfoam_var = csv_to_dict(
        to_absolute_path(
            "../openfoam/FPGA_re13239.6_tanh_OF_blockMesh_solid_fullFake.csv"
        ),
        mapping,
    )
