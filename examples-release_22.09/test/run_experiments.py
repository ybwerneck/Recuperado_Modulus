...
def get_experiments(
    ...
    """Gets dictionary of expirements to run from JSON file
    ...
    # Tag must be present in run options field
    assert run_opt in data["run_opts"], f"Invalid expirment tag {tag}"
...
if __name__ == "__main__":
    ...
    if args.gpus is None:
        ...
        availible_gpus = [int(x) for x in args.gpus.split(",")]
    if not availible_gpus:
    ...
    for tag in tags:
        ...
        q = Que(availible_gpus=availible_gpus, print_type="que")
