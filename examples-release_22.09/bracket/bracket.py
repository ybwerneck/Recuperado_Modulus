...
from modulus.geometry.primitives_3d import Box, Cylinder
...
def run(cfg: ModulusConfig) -> None:
    ...
    commercial_solver_var = csv_to_dict(
        to_absolute_path("commercial_solver/deformation_x.txt"), mapping, delimiter="\t"
    )
    ...
    commercial_solver_var_sxx = csv_to_dict(
        to_absolute_path("commercial_solver/normal_x.txt"), mapping_sxx, delimiter="\t"
    )
    commercial_solver_var_syy = csv_to_dict(
        to_absolute_path("commercial_solver/normal_y.txt"), mapping_syy, delimiter="\t"
    )
    commercial_solver_var_szz = csv_to_dict(
        to_absolute_path("commercial_solver/normal_z.txt"), mapping_szz, delimiter="\t"
    )
    commercial_solver_var_sxy = csv_to_dict(
        to_absolute_path("commercial_solver/shear_xy.txt"), mapping_sxy, delimiter="\t"
    )
    commercial_solver_var_sxz = csv_to_dict(
        to_absolute_path("commercial_solver/shear_xz.txt"), mapping_sxz, delimiter="\t"
    )
    commercial_solver_var_syz = csv_to_dict(
        to_absolute_path("commercial_solver/shear_yz.txt"), mapping_syz, delimiter="\t"
    )
